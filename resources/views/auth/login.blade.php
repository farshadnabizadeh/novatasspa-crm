...
<head>
    ...
    <title>NOVATAS SPA CRM</title>
    <link rel="dns-prefetch" href="//fonts.gstatic.com">
    <link type="text/css" href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link rel="shortcut icon" href="{{ asset('assets/img/novatasspa.png') }}" type="image/x-icon">
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><img class="logo" src="{{ asset('assets/img/novatasspa.png') }}"></div>
