                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 mt-4">
                            <h2 class="text-white">Approval Calendar</h2>
                            <hr>
            ...
            $(document).ready(function(){
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: [
                        ...
                        {
                            title: '{{ $treatmentplan->countR }} Patient,  {{ $treatmentplan->name }}',
                            start: '{{ $treatmentplan->date }}',
                            description: '{{ $treatmentplan->countR }} Patient,  {{ $treatmentplan->name }}',
                            end: '{{ $treatmentplan->date }}',
                            color: '{{ $treatmentplan->color }}',
                            url: '{{ url('/bydate?s='.$treatmentplan->date) }}',
                            textColor: '#fff',
                        },
                        @endforeach
                    ],
